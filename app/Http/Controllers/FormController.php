...
//        return response()->json(['error' => $validator->errors()->all()]);
    ...
    private function sendTo1C($xml, $type)
    {
        ...
        if (Storage::put($path, $xml->asXML())) {
            ...
            return ['error' => ' К сожалению Ваше обращение не может быть доставлено сейчас. Пожалуйста, напишите нам по эл.почте по адресу  <a href="mailto:abc@print.ru" style="font-size: 18px;">abc@print.ru</a> или позвоните по телефону <a href="tel:88001006550">8(800) 100-65-50</a>. Спасибо. Приносим свои извинения'];
        } else {
