...
//        return response()->json(['error' => $validator->errors()->all()]);
    ...
    private function sendTo1C($xml, $type)
    {
        ...
        if (Storage::put($path, $xml->asXML())) {
            ...
            return ['error' => 'К сожалению Ваше обращение не может быть доставлено сейчас. Напишите нам по эл.почте на адрес <a href="mailto:kser1@list.ru" style="font-size: 18px;">abc@print.ru</a>. Спасибо. Приносим свои извинения.'];
        } else {
